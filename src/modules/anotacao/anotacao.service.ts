...
export const anotacaoService = {
  ...
  async create(userId: number, data: { titulo: string; conteudo?: string; favorita?: boolean }) {
  ...
  async update(userId: number, id: number, data: { titulo?: string; conteudo?: string; favorita?: boolean }) {
